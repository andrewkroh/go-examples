...
@members {
// isSlashRegex returns true if the preceding token is a '/'.
func (p *PainlessLexer) isSlashRegex() bool {
    panic("isSlashRegex() - Not implemented")
}
}
